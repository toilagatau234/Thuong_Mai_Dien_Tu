...
export const routes = [
    ...
    // === 👇 2. MỚI THÊM: Định nghĩa đường dẫn Order Success ===
    {
        path: '/order-success',
    ...
    { path: 'users', page: UserPage, isShowHeader: true },
    { path: 'user/add', page: UserAddPage, isShowHeader: true },
    { path: 'user/edit/:id', page: UserEditPage, isShowHeader: true },
]